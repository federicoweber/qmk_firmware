...
const is31_led g_is31_leds[DRIVER_LED_TOTAL] = {
    ...
    {1, C1_3, C2_3, C3_3},     //33 led36
    {1, C1_2, C2_2, C4_3},     //34 led37
    {1, C1_1, C3_2, C4_2},     //35 led37bis
    {1, C9_1, C8_1, C7_1},     //36 led38
    {1, C9_2, C8_2, C7_2},     //37 led39
    {1, C9_3, C8_3, C7_3},     //38 led40
    {1, C9_5, C8_5, C7_5},     //39 led42
    {1, C9_6, C8_6, C7_6},     //40 led43
    {1, C9_7, C8_7, C6_6},     //41 led44
    {1, C9_8, C7_7, C6_7},     //42 led45
    {1, C1_16, C2_16, C3_16},  //43 led46
    {1, C1_15, C2_15, C3_15},  //44 led47
    {1, C1_14, C2_14, C3_14},  //45 led48
    {1, C1_13, C2_13, C3_13},  //46 led49
    {1, C1_12, C2_12, C3_12},  //47 led50
    {1, C1_11, C2_11, C3_11},  //48 led51
    {1, C1_10, C2_10, C4_11},  //49 led52
    {1, C1_9, C3_10, C4_10},   //50 led52bis
    {1, C9_9, C8_9, C7_9},     //51 led53
    {1, C9_10, C8_10, C7_10},  //52 led54
    {1, C9_11, C8_11, C7_11},  //53 led55
    {1, C9_12, C8_12, C7_12},  //54 led56
    {1, C9_13, C8_13, C7_13},  //55 led57
    {1, C9_14, C8_14, C7_14},  //56 led58
    {1, C9_15, C8_15, C6_14},  //57 led59
    {1, C9_16, C7_15, C6_15},  //58 led60
};

led_config_t g_led_config = { {
    // Key Matrix to LED Index
    // 1, 6, 10, 15, 20, 26, 31, 37, 42, 47, 52, 56
    {0, 5, 10, 15, 20, 25, 29, 34, 39, 44, 49, 54},
    // 2, 7, 11, 16, 21, 27, 32, 37bis, 43, 48, 52bis, 57
    {1, 6, 11, 16, 21, 26, 30, 35, 40, 45, 50, 55},
    // 3, 7bis, 12, 17, 22, 28, 33, 38, 44, 49, 53, 58
    {2, 7, 12, 17, 22, 27, 31, 36, 41, 46, 51, 56},
    // 4, 8, 13, 18, 23, 29, 34, 39, 45, 50, 54, 59
    {3, 8, 13, 18, 23, 28, 32, 37, 42, 47, 52, 57},
    // 5, 9, 14, 19, 24, NO_LED, 36, 40, 46, 51, 55, 60
    {4, 9, 14, 19, 24, NO_LED, 33, 38, 43, 48, 53, 58},
}, {
